...
Copyright © 2024-2025 결속(Gyeolsok). All Rights Reserved.

본 소프트웨어 및 관련 문서 파일(이하 "소프트웨어")에 대한 모든 권리는 저작권자가 보유합니다.

**사용 제한**:
- 본 소프트웨어는 개인적, 비상업적 용도로만 사용할 수 있습니다.
- 소프트웨어의 복사, 수정, 병합, 게시, 배포, 재라이선스 및 판매는 저작권자의 명시적인 서면 허가 없이 금지됩니다.
- 소프트웨어를 사용하여 생성된 가계도 및 산출물에 대한 권리는 사용자에게 있습니다.

**면책 조항**:
본 소프트웨어는 "있는 그대로" 제공되며, 명시적이거나 묵시적인 어떠한 보증도 하지 않습니다.
저작권자는 소프트웨어의 사용으로 인해 발생하는 어떠한 청구, 손해 또는 기타 책임에 대해서도 책임지지 않습니다.

**문의**: 라이선스 및 상업적 사용에 대한 문의는 [연락처]로 연락주시기 바랍니다.
